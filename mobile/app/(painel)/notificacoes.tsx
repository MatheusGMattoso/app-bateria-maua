  ...
  return (
    <SafeAreaView className="flex-1" style={{ backgroundColor: colors.background }}>
      <ScrollView contentContainerStyle={{ padding: screenPadding, paddingBottom: 40 }}>
        <ScreenHeader
          title="Lembretes"
          subtitle="Configure avisos de ensaios, eventos e frequência PAE."
          right={<ThemeToggle />}
        />
        ...
        <Text className="text-xs text-center px-4" style={{ color: colors.textMuted }}>
          Lembretes locais funcionam no Expo Go. Push remoto com app fechado requer EAS Build na Fase 2.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
